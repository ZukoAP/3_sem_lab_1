...
TEST(ShellSorterTestSuite, ArraySeqNullSize) {
    ArraySeq<int> seq;
...
TEST(ShellSorterTestSuite, ArraySequenceEqualElements) {
...
TEST(ShellSorterTestSuite, ArraySequenceUsualAscending) {
...
TEST(ShellSorterTestSuite, ArraySequenceUsualDescending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ArraySeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ArraySequenceLarge) {
...
TEST(ShellSorterTestSuite, ArraySequenceSortedDirectly) {
    std::vector<int> initial = generateDataLarge(10000);
    ArraySeq<int> seq;
    std::sort(initial.begin(), initial.end(), less<>());
    for (const auto& elem: initial) {
...
TEST(ShellSorterTestSuite, ArraySequenceSortedReverse) {
    std::vector<int> initial = generateDataLarge(10000);
    ArraySeq<int> seq;
    std::sort(initial.begin(), initial.end(), greater<>());
    for (const auto& elem: initial) {
...
TEST(ShellSorterTestSuite, ArraySequenceSmallValues) {
...
TEST(ShellSorterTestSuite, ArraySequenceWithNegative) {
    std::vector<int> initial = {1, 5, -2, 7, 3, -234, 4564364, -465, -2243, 890, -45, 56, 345, -98, 0};
    ArraySeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ListSeqNullSize) {
    ListSeq<int> seq;
    auto* sorter = new ShellSorter<int>;
    Sequence<int>* res = sorter->sort(&seq, &lessThan<>);
    ASSERT_EQ(0, res->length()) << "Resultant sequence is not empty";
...
TEST(ShellSorterTestSuite, ListSequenceUsualAscending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ListSequenceUsualDescending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ListSequenceLarge) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ListSequenceSortedDirectly) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    std::sort(initial.begin(), initial.end(), less<>());
    for (const auto& elem: initial) {
...
TEST(ShellSorterTestSuite, ListSequenceSortedReverse) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    std::sort(initial.begin(), initial.end(), greater<>());
    for (const auto& elem: initial) {
...
TEST(ShellSorterTestSuite, ListSequenceWithNegative) {
    std::vector<int> initial = {1, 5, -2, 7, 3, -234, 4564364, -465, -2243, 890, -45, 56, 345, -98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(ShellSorterTestSuite, ListSequenceSmallValues) {
    std::vector<int> initial = generateDataSmall(10000);
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
