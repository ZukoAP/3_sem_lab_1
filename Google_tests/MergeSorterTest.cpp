...
TEST(MergeSorterTestSuite, ArraySeqNullSize) {
    ArraySeq<int> seq;
...
TEST(MergeSorterTestSuite, ArraySequenceEqualElements) {
...
TEST(MergeSorterTestSuite, ArraySequenceUsualAscending) {
...
TEST(MergeSorterTestSuite, ArraySequenceUsualDescending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ArraySeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ArraySequenceLarge) {
...
TEST(MergeSorterTestSuite, ArraySequenceSortedDirectly) {
    std::vector<int> initial = generateDataLarge(10000);
    ArraySeq<int> seq;
    std::sort(initial.begin(), initial.end(), less<>());
    for (const auto& elem: initial) {
...
TEST(MergeSorterTestSuite, ArraySequenceSortedReverse) {
    std::vector<int> initial = generateDataLarge(10000);
    ArraySeq<int> seq;
    std::sort(initial.begin(), initial.end(), greater<>());
    for (const auto& elem: initial) {
...
TEST(MergeSorterTestSuite, ArraySequenceSmallValues) {
...
TEST(MergeSorterTestSuite, ArraySequenceWithNegative) {
    std::vector<int> initial = {1, 5, -2, 7, 3, -234, 4564364, -465, -2243, 890, -45, 56, 345, -98, 0};
    ArraySeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ListSeqNullSize) {
    ListSeq<int> seq;
    auto* sorter = new MergeSorter<int>;
    Sequence<int>* res = sorter->sort(&seq, &lessThan<>);
    ASSERT_EQ(0, res->length()) << "Resultant sequence is not empty";
...
TEST(MergeSorterTestSuite, ListSequenceUsualAscending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ListSequenceUsualDescending) {
    std::vector<int> initial = {1, 5, 2, 7, 3, 234, 4564364, 465, 2243, 890, 45, 56, 345, 98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ListSequenceLarge) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ListSequenceSortedDirectly) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    std::sort(initial.begin(), initial.end(), less<>());
    for (const auto& elem: initial) {
...
TEST(MergeSorterTestSuite, ListSequenceSortedReverse) {
    std::vector<int> initial = generateDataLarge(10000);
    ListSeq<int> seq;
    std::sort(initial.begin(), initial.end(), greater<>());
    for (const auto& elem: initial) {
...
TEST(MergeSorterTestSuite, ListSequenceWithNegative) {
    std::vector<int> initial = {1, 5, -2, 7, 3, -234, 4564364, -465, -2243, 890, -45, 56, 345, -98, 0};
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
...
TEST(MergeSorterTestSuite, ListSequenceSmallValues) {
    std::vector<int> initial = generateDataSmall(10000);
    ListSeq<int> seq;
    for (const auto& elem: initial) {
        seq.append(elem);
